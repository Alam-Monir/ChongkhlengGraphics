...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <a class="navbar-brand mx-auto d-lg-none" href="#">
      <img src="./auth/img/water.png" alt="Logo" width="65" height="65" class="d-inline-block align-text-top">
    </a>

    <a class="navbar-brand d-none d-lg-block " href="#">
      <img src="./auth/img/water.png" alt="Logo" width="70" height="70" class="d-inline-block align-text-top">
    </a>
...
<!--brands-list-->
<div class="d-flex flex justify-content-evenly mt-4 mb-5 p-3">
  <a href="#">
