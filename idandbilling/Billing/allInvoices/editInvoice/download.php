...
if ($invoiceId > 0) {
    try {
        ...
        $gstPercentageStore = $invoice['gstPercentage'] ?? 1;
        $hideGst = ($gstPercentageStore == 1) ? 'style="display: none;"' : '';
        ...
        <table class="table" id="dataTable">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="gst-column-head" <?= $hideGst; ?>>GST</th>
                    <th scope="col" class="gstAmount-column-head" <?= $hideGst; ?>>GST Amount</th>
